        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TempSessionId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TempPizzaName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TempSize = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TempDough = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TempSauce = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TempCheese = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TempMeat = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TempVegetable = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TempPrice = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserDatas_Status_StatusId",
                        column: x => x.StatusId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VegetableId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MeatsVegetables", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MeatsVegetables_Meats_MeatId",
                        column: x => x.MeatId,
                        principalTable: "Meats",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MeatsVegetables_Pizzas_PizzaId",
                        column: x => x.PizzaId,
                        principalTable: "Pizzas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MeatsVegetables_Vegetables_VegetableId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Dough = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Sauce = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Cheese = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "pepperoni", 5.2000000000000002 },
                    { 2, "szynka", 5.2000000000000002 },
                    { 3, "wołowina", 5.2000000000000002 },
                    { 4, "wieprzowina", 5.2000000000000002 },
                    { 5, "kurczak", 5.2000000000000002 },
                    { 6, "boczek", 5.2000000000000002 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "sos pomidorowy", 2.0 },
                    { 2, "sos kremowy", 2.0 },
                    { 3, "sos pikantny pomidorowy", 2.0 },
                    { 4, "sos czosnkowy", 2.0 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MeatsVegetables_MeatId",
                table: "MeatsVegetables",
                column: "MeatId");

            migrationBuilder.CreateIndex(
                name: "IX_MeatsVegetables_PizzaId",
                table: "MeatsVegetables",
                column: "PizzaId");

            migrationBuilder.CreateIndex(
                name: "IX_MeatsVegetables_VegetableId",
                table: "MeatsVegetables",
                column: "VegetableId");
